 ...
 * 
 */
@WebServiceClient(name = "WeatherService", targetNamespace = "http://www.example.org/WeatherService/", wsdlLocation = "file:/S:/WorkSpace/FileHandling/TopDown-Webservices-Tomcat10/weatherService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICE_QNAME = new QName("http://www.example.org/WeatherService/", "WeatherService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/S:/WorkSpace/FileHandling/TopDown-Webservices-Tomcat10/weatherService.wsdl");
    ...
    public WeatherServicePortType getWeatherServiceSOAP() {
        return super.getPort(new QName("http://www.example.org/WeatherService/", "WeatherServiceSOAP"), WeatherServicePortType.class);
    }
     ...
     */
    @WebEndpoint(name = "WeatherServiceSOAP")
    public WeatherServicePortType getWeatherServiceSOAP(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.example.org/WeatherService/", "WeatherServiceSOAP"), WeatherServicePortType.class, features);
    }

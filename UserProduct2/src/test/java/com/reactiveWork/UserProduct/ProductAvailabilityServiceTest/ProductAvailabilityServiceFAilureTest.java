 ...
 *
 */
public class ProductAvailabilityServiceFAilureTest {
	...
	public void testGetAllProductForUser() {
		...
		Assert.assertEquals(actual.get(0).getProductId(), expected.get(1).getProductId());
		Assert.assertEquals(actual.get(0).getProductCategory(), expected.get(1).getProductCategory());
		Assert.assertEquals("" + actual.get(0).getPrice(),"" +expected.get(1).getPrice());
		Assert.assertEquals(actual.get(0).getAvailableCity(), expected.get(1).getAvailableCity());

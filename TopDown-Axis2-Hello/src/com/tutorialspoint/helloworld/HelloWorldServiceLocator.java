...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.tutorialspoint.helloworld.HelloWorldService {
    ...
    private java.lang.String HelloWorldPort_address = "http://localhost:8082/HelloServerPort";
    ...
    public com.tutorialspoint.helloworld.HelloWorldPortType getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.tutorialspoint.helloworld.HelloWorldSoapBindingStub _stub = new com.tutorialspoint.helloworld.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.tutorialspoint.helloworld.HelloWorldPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.tutorialspoint.helloworld.HelloWorldSoapBindingStub _stub = new com.tutorialspoint.helloworld.HelloWorldSoapBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://helloworld.tutorialspoint.com/", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://helloworld.tutorialspoint.com/", "HelloWorldPort"));
        }

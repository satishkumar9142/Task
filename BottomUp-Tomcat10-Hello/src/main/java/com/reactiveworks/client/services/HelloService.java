...
package com.reactiveworks.client.services;
 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://services.reactiveworks.com/", wsdlLocation = "http://localhost:9090/BottomUp-Tomcat10-Hello/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://services.reactiveworks.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/BottomUp-Tomcat10-Hello/ws/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://services.reactiveworks.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.reactiveworks.com/", "HelloPort"), Hello.class, features);
    }
